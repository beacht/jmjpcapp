...
import { formatPhoneNumber, formatTime, getClientById } from '../Helpers';
  ...
  return (
    <div>
      ...
      {appointments.map((appointment, index) => {
        const client = getClientById(appointment.client, clients);
      ...
      {messages.map((message, index) => {
        const client = getClientById(message.client, clients);
